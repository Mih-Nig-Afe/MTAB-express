CREATE TYPE parcel_status_enum AS ENUM ('created', 'received_at_origin', 'processed_at_origin', 'dispatched_from_origin', 'in_transit', 'arrived_origin_airport', 'checked_in_flight', 'departed', 'arrived_destination_airport', 'released_from_airport', 'arrived_at_destination', 'distributed_to_branch', 'ready_for_pickup', 'delivered', 'returned', 'cancelled', 'lost', 'on_hold');
